...
use crate::repository::role::{
    ALL_PERMISSIONS, PERMISSION_ARTICLE_CREATE, PERMISSION_ARTICLE_DELETE_TRANSFER,
    PERMISSION_COMMENT_CREATE, PERMISSION_COMMENT_DELETE_TRANSFER, REQUIRED_ROLES, ROLE_ADMIN,
    ROLE_MEMBER,
};
...
pub async fn seed_sample_articles(
    ...
    for author_index in 0..author_count {
        ...
        let user_id = create_user(db, &nail_common::hash::email(&email))
            .await
