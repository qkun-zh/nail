...
use cache::UserId;
use common::request::{UserDeleteQuery, UserUpdateRequest};
...
async fn delete_user_transfer_after_email_confirmation() {
    ...
    let _ = crate::logic::email::create_token(
        &context.state,
        common::request::CreateTokenRequest {
            purpose: common::request::TokenPurpose::DeleteUser,
...
async fn create_user_rejects_a_soft_deleted_account() {
    ...
    let _ = crate::logic::email::create_token(
        &context.state,
        common::request::CreateTokenRequest {
            purpose: common::request::TokenPurpose::CreateUser,
