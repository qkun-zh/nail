...
use crate::repository::role::{
    ...
    PERMISSION_TAG_UNAPPLY, PERMISSION_VERSION_READ, REQUIRED_ROLES, ROLE_ADMIN, ROLE_MEMBER,
};
...
fn seed_roles_and_permissions(db: &Database) -> anyhow::Result<()> {
    ...
    crate::repository::role::grant_permission_to_role(db, ROLE_MEMBER, PERMISSION_TAG_UNAPPLY)?;
