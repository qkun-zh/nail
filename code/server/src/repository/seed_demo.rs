...
pub async fn seed_sample_articles(
    ...
    for author_index in 0..author_count {
        ...
        let user_id =
            crate::repository::user::create_user(db, &common::hash::hash(email.as_bytes())?)
    ...
    for index in 0..count {
        ...
        let article_id = common::time::uuidv7_min_for_ms(sample_ms);
        let version_id = common::time::uuidv7_max_for_ms(sample_ms);
