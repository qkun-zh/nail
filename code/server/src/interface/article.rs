...
use common::request::{DeleteQuery, UpdateArticleRequest};
use common::response::article::CreateArticleView;
...
pub async fn search_articles(
    ...
    principal: Principal,
    AppQuery(params): AppQuery<common::request::ArticleSearchParams>,
