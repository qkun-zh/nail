...
- **`document/context.md`** — the glossary (ubiquitous language) at the repo
  root's `document/` directory.
- **`document/adr/`** — ADRs that touch the area you're about to work in.
...
│   ├── adjudication.md       ← decision/issues log
│   ├── handoff.md            ← progress
│   └── adr/
│       ├── 0001-<slug>.md
│       └── 0002-<slug>.md
...
`document/context.md`. Don't drift to synonyms the glossary explicitly avoids.
